		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Themse app",
									"targetURL": "#sapui5schoolthemes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5schoolthemes-display": {
								"semanticObject": "sapui5schoolthemes",
								"action": "display",
								"description": "Sample SAPUI5 Application",
								"title": "Themse app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5school.themes",
									"url": sap.ui.require.toUrl("sapui5school/themes")
								}
							}
						}
					}
